...
export interface ApiInvoiceItemInvoiceItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    unitPrice: Schema.Attribute.Float & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiInvoiceInvoice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    paymentMethod: Schema.Attribute.Enumeration<
      ['bank_transfer', 'card', 'crypto', 'cash']
    > &
...
export interface ApiWorkspaceWorkspace extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Multi-tenant workspace for invoice management';
  ...
  attributes: {
    ...
    defaultPaymentTerms: Schema.Attribute.Integer &
