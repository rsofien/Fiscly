  ...
  try {
    ...
    if (workspaces.length === 0) {
      ...
      return NextResponse.json({
        ...
        personal_name: newWorkspace.personal_name || "",
        personal_email: newWorkspace.personal_email || "",
        personal_phone: newWorkspace.personal_phone || "",
    ...
    const updateResponse = await fetch(`${STRAPI_URL}/api/workspaces/${documentId}`, {
      ...
      body: JSON.stringify({
        data: {
          ...
          personal_name: updateData.personal_name,
          personal_email: updateData.personal_email,
          personal_phone: updateData.personal_phone,
